...
\zihao{4}\linespread{1.5}\selectfont% local line space
\input{Tex/Frontmatter}% title page, abstract

% \intotoc*{\cleardoublepage}{摘要}% add link to toc
...
%-> Mainmatter
%-
\zihao{-4}\linespread{1.6}\selectfont% local line space
